...
/-!
# The literal signed-shadow row at weight four

The strict import chain keeps the three expanded transforms in separate
Lean processes and therefore bounds peak memory.
-/
...
/-- The weight-four signed-shadow identity obtained from the parity-kernel and
stabilizer MacWilliams transforms of an odd candidate. -/
theorem oddSignedShadow4
    ...
    -50193 * (weightDistribution S 1 : ℤ) +
      ...
      6361 * weightDistribution S 4 - 1841 * weightDistribution S 5 -
      ...
      1001 * weightDistribution S 14 -
      2048 * shadowWeightDistribution S hcandidate.2.1 4 = -81081 := by
  ...
  have hpartition :
      weightDistribution (symplecticNormalizer K) 4 =
  ...
  have hK := macWilliams_coefficient_of_fixedWeightCharacterSum
    K fixedWeightCharacterSum_14_4
  ...
  norm_num at hK
  have hS := oddMacWilliams4 S hcandidate
